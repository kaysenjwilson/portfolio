    ...
    <section className='lg:py-16'>
        <div className='grid  grid-cols-1 lg:grid-cols-12'>
            <div className="col-span-8 place-self-center text-center sm:text-left justify-self-start">
                ...
                <div>
                    <button className='px-6 py-3  w-full sm:w-fit rounded-full mr-4 bg-white bg-gradient-to-br from-blue-500 via-primary-500 to-secondary-500 hover:bg-slate-200 text-white'>Hire me</button>
